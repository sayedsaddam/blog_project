	...
	<?php if($article): ?>
		<div class="row">
			...
			<div class="col-md-8">
				...
				<img src="<?= !empty($article->attachment) ? base_url('attachments/articles/'.$article->attachment) : base_url('assets/images/no-image.jpg'); ?>" alt="<?= $article->slug; ?>" class="img-fluid mb-3" style="width: 100%; height: 50%;">
