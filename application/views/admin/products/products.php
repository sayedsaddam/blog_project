<div class="container">
	<div class="row mb-4">
		<div class="col-md-6 col-sm-12">
			<h1 class="font-weight-light">Products List &raquo; 
				<a href="<?= base_url('product/trashed_products'); ?>" class="btn btn-outline-danger btn-sm rounded-0" title="view unpublished products...">View Trash</a>
			</h1>
		</div>
			...
			<table class="table table-condensed table-hover table-sm">
				...
				<tbody>
					...
					<tr id="<?= $data->id; ?>">
						...
						<th>
							<img src="<?= base_url('attachments/products/'.$data->image); ?>" alt="<?= $data->product_name; ?>" class="img-thumbnail" width="50">
						</th>
						<td>
