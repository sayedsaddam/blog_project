	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="row">
					...
					<div class="row mb-4">
						<div class="col-md-5">
							<a href="<?= base_url('blog/'.$data->slug); ?>">
								<img src="<?= !empty($data->attachment) ? base_url('attachments/articles/'.$data->attachment) : base_url('assets/images/no-image.jpg'); ?>" alt="<?= $data->slug; ?>" class="img-thumbnail rounded-0">
							</a>
						</div>
						<div class="col-md-7">
				...
				<?php endforeach; else: echo '<div class="col-md-12 mb-5"><div class="alert alert-danger lead">No articles found based on your search query, try another one.</div></div>'; endif; ?>
			</div>
